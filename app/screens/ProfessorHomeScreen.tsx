...
export default function ProfessorSessionScreen({ route, navigation }: any) {
  ...
  // عداد المحاضرات لكل كورس
  const [lectureCounters, setLectureCounters] = useState<{[key:string]:number}>({
    CS308:1,
    CS306:1,
    CS303:1,
    CS316:1,
  ...
  const handleCreateSession = () => {
    ...
    // زيادة رقم المحاضرة للكورس المختار
