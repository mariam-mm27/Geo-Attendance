                ...
                {course.attendanceData && (
                  <>
                    <p>
                      ...
                      <strong style={{
                        color:
                          parseFloat(course.attendanceData.avgAttendance) >= 75
                            ? "#10B981"
                            : parseFloat(course.attendanceData.avgAttendance) >= 50
                              ? "#F59E0B"
                              : "#EF4444",
                        marginLeft: "5px"
                      }}>
...
const styles = {
  ...
  reportBtn: { width: "100%", padding: "12px", borderRadius: "10px", border: "none", backgroundColor: "#173B66", color: "white", fontWeight: "bold", cursor: "pointer", transition: "0.3s" },
