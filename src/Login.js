...
function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (!userSnap.exists()) {
        alert(
          "This Google account is not registered in our database. Please register first.",
        );
        await signOut(auth);
        return;
      }
  ...
  const redirectUser = (userData, userEmail) => {
    ...
    if (userRoleInDB !== detectedRole) {
      alert(
        `Role Mismatch! Your email indicates you are ${detectedRole}, but DB says ${userRoleInDB}.`,
      );
      signOut(auth);
      return;
    }
    ...
    >
      ...
      {showForgotPassword && (
        ...
        >
          ...
          >
            <h2
              style={{ color: "#173B66", marginTop: 0, marginBottom: "10px" }}
            >
              Reset Password
            </h2>
            <p
      ...
      >
        <div style={{ textAlign: "center" }}>
          <h1
            style={{ color: "#173B66", marginBottom: "5px", fontSize: "32px" }}
          >
            Attendance
          </h1>
          <h2
            style={{ color: "#173B66", fontSize: "24px", marginBottom: "20px" }}
          >
            Login
          </h2>
        </div>
